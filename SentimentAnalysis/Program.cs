...
namespace SentimentAnalysis
{
    class Program
    {
        ...
        static readonly string _dataPath = Path.Combine(Environment.CurrentDirectory, "Data", "train.txt");
        static readonly string _testPath = Path.Combine(Environment.CurrentDirectory, "Data", "test.txt");
        // </SnippetDeclareGlobalVariables>
        ...
        static void Main(string[] args)
        {
            ...
            IDataView trainData = mlContext.Data.LoadFromTextFile<SentimentData>(_dataPath, hasHeader: false);


            IDataView testData = mlContext.Data.LoadFromTextFile<SentimentData>(_testPath, hasHeader: false);
        ...
        */
        ...
        private static void UseModelWithSingleItem(MLContext mlContext, ITransformer model)
        {
            ...
            {
                SentimentText = "Coding is bad and stupid"
            };
            // </SnippetCreateTestIssue1>
        ...
        public static void UseModelWithBatchItems(MLContext mlContext, ITransformer model)
        {
            ...
            IEnumerable<SentimentData> sentiments = new[]
            {
                new SentimentData
                {
                    SentimentText = "This AI model is hot garbage"
                },
                new SentimentData
                {
                    SentimentText = "I love this class and I love Mr. Tanczo's leniency and teaching"
                }
            };
            // </SnippetCreateTestIssues>
